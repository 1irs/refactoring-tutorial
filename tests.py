...
def test_single_product() -> None:
    cart = ShoppingCart()
    cart.add_entry(CartEntry(Product("T-shirt", 20.0), 2))
    assert cart.description() == (
        "Cart contents:\n"
        "* T-shirt X 2 = 40.0 (discount 0.0)\n"
        "Total cost: 40.0\n"
        "Discount: 0.0\n"
        "Final cost: 40.0\n"
    )
...
def test_two_products() -> None:
    cart = ShoppingCart()
    cart.add_entry(CartEntry(Product("T-shirt", 20.0), 2))
    cart.add_entry(CartEntry(Product("Coca-cola", 15.0), 1))
    assert cart.description() == (
        "Cart contents:\n"
        "* T-shirt X 2 = 40.0 (discount 0.0)\n"
        "* Coca-cola X 1 = 15.0 (discount 0.0)\n"
        "Total cost: 55.0\n"
        "Discount: 0.0\n"
        "Final cost: 55.0\n"
    )
...
def test_five_or_more_discount() -> None:
    ...
    assert cart.description() == (
        "Cart contents:\n"
        "* T-shirt X 5 = 100.0 (discount 5.0)\n"
        "Total cost: 100.0\n"
        "Discount: 5.0\n"
        "Final cost: 95.0\n"
    )
...
def test_each_third_free_discount() -> None:
    ...
    assert cart.description() == (
        "Cart contents:\n"
        "* T-shirt X 7 = 140.0 (discount 40.0)\n"
        "Total cost: 140.0\n"
        "Discount: 40.0\n"
        "Final cost: 100.0\n"
    )
...
def test_minus_10_coupon() -> None:
    ...
    assert cart.description() == (
        "Cart contents:\n"
        "* T-shirt X 7 = 140.0 (discount 10.0)\n"
        "Total cost: 140.0\n"
        "Discount: 10.0\n"
        "Final cost: 130.0\n"
    )
